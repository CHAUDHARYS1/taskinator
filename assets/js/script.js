...
/**** TASK STATUS CHANGE FUNCTION ****/
 var taskStatusChangeHandler = function(event){
    ...
    // change task to different columns depending on the status
...
// no data attribute, so create an object as normal and pass to createTaskEl function
else{
    var taskDataObj = {
        name:taskNameInput, 
        type:taskTypeInput,
...
var createTaskActions = function (taskId) {
  ...
  actionContainerEl.append(statusSelectEl);
...
var editTask = function (taskId) {
  ...
  // get value from task inputs
  document.querySelector("input[name='task-name']").value = taskName;
  document.querySelector("select[name='task-type']").value = taskType;
  // change button text once task is edited
